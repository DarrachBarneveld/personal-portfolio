...
const ProjectCard: FunctionComponent<ProjectProps> = ({
  ...
  return (
    <Link href={`/projects/${id}`} className="group outline-none">
      <article className="relative h-[20rem] max-w-[35rem] flex-1 overflow-hidden rounded-lg border-2 border-black/20 bg-white transition hover:cursor-pointer hover:border-indigo-500 hover:bg-gray-200 group-focus:bg-gray-200 group-focus:outline-none group-focus:ring-2 group-focus:ring-indigo-500 ">
        <Image
          src={imageUrl}
        ...
        />
        <div className="flex h-full flex-col p-2 md:max-w-[50%] md:pl-10 md:pr-2 md:group-even:ml-[16rem] lg:p-5">
